...
function MultiImageSelectCompressExpo(_ref) {
  var open = _ref.open,
      ...
      largestDimensionClamp = _ref.largestDimensionClamp,
  ...
  var _useState7 = (0, _react.useState)(0),
      ...
      imagesLoaded = _useState8[0],
      setImagesLoaded = _useState8[1];
  ...
  var _useMediaLibraryImage = (0, _useMediaLibraryImages["default"])(),
      ...
      resetImageState = _useMediaLibraryImage3.resetImageState; // reset to initial state
  ...
  var markImageLoaded = function markImageLoaded() {
  ...
  var compressSingleImage = function compressSingleImage(img) {
    ...
    if (img && img.width && img.height) {
      ...
      var largerDim = width > height ? width : height; // if the dimension is larger than largestDimensionClamp resize to largestDimensionClamp =

      var largestSideValue = largerDim > largestDimensionClamp ? largestDimensionClamp : largerDim; // edit transform config with new data
  ...
  return /*#__PURE__*/_react["default"].createElement(_reactNative.Modal, {
    animationType: "slide",
    visible: open
  }, /*#__PURE__*/_react["default"].createElement(_reactNative.SafeAreaView, null, /*#__PURE__*/_react["default"].createElement(_LoadingView["default"], {
    visible: isLoading,
    colors: combinedColors
...
MultiImageSelectCompressExpo.propTypes = {
  ...
  largestDimensionClamp: _propTypes["default"].number,
