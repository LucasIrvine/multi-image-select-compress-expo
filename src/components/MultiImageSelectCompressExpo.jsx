...
export default function MultiImageSelectCompressExpo({
	...
	const compressSingleImage = (img) => {
		...
		if (img && img.width && img.height) {
			...
			// if the dimension is larger than dimensionClamp resize to dimensionClamp =
			const largestSideValue = largerDim > dimensionClamp ? dimensionClamp : largerDim;
...
MultiImageSelectCompressExpo.propTypes = {
	...
	dimensionClamp: PropTypes.number,
